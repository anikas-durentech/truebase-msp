    ...
    {#if isLoaded}
        ...
        <div class="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
                ...
                <a href="/contact" class="hidden md:flex group items-center gap-2 bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-4 rounded-full font-bold text-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 w-full sm:w-auto shadow-lg">
                ...
                <a href="tel:+16784397037" class="flex md:hidden group items-center justify-center gap-2 bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-4 rounded-full font-bold text-lg hover:-translate-y-1 hover:shadow-xl transition-all duration-300 w-full sm:w-auto shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
