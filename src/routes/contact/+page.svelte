...
<section class="py-20 bg-gray-50 min-h-screen">
    <div class="container mx-auto px-6 max-w-6xl">
        <div class="text-center mb-16">
            <h1 class="font-heading text-4xl md:text-5xl font-bold text-blue-900 mb-4">Get in Touch</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="p-8 md:p-12">
                ...
                <form action="https://formspree.io/f/meerzave" method="POST" class="space-y-6">
                    ...
                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded-lg transition-colors duration-300 shadow-md">
                        Send Message
                    </button>
                </form>
            </div>

            <div class="bg-blue-900 text-white p-8 md:p-12 flex flex-col justify-center">
                ...
                <div class="space-y-8">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="tel:+1234567890" class="text-xl font-bold hover:text-blue-300 transition-colors">+1 (678) 439-7037</a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:support@truebasemsp.com" target="_blank" class="text-xl font-bold hover:text-blue-300 transition-colors">support@truebaseit.com</a>
                        </div>
                    </div>
